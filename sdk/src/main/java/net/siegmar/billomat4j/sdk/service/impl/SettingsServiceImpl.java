...
import net.siegmar.billomat4j.sdk.domain.settings.CountryTax;
import net.siegmar.billomat4j.sdk.domain.settings.CountryTaxes;
import net.siegmar.billomat4j.sdk.domain.settings.ReminderText;
import net.siegmar.billomat4j.sdk.domain.settings.ReminderTexts;
import net.siegmar.billomat4j.sdk.domain.settings.Settings;
import net.siegmar.billomat4j.sdk.domain.settings.Tax;
import net.siegmar.billomat4j.sdk.domain.settings.Taxes;
