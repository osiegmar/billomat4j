...
import net.siegmar.billomat4j.sdk.domain.AbstractDocumentPdf;
import net.siegmar.billomat4j.sdk.domain.DocumentComplete;
import net.siegmar.billomat4j.sdk.domain.Email;
import net.siegmar.billomat4j.sdk.domain.Filter;
import net.siegmar.billomat4j.sdk.domain.Identifiable;
import net.siegmar.billomat4j.sdk.domain.Pageable;
import net.siegmar.billomat4j.sdk.domain.WrappedRecord;
