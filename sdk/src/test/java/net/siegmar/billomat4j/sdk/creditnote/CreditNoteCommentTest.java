...
import net.siegmar.billomat4j.sdk.AbstractCommentTest;
import net.siegmar.billomat4j.sdk.domain.client.Client;
import net.siegmar.billomat4j.sdk.domain.creditnote.CreditNote;
import net.siegmar.billomat4j.sdk.domain.creditnote.CreditNoteActionKey;
...
public class CreditNoteCommentTest extends AbstractCommentTest<CreditNoteActionKey, CreditNoteComment, CreditNoteCommentFilter> {

    public CreditNoteCommentTest() {
