...
import net.siegmar.billomat4j.sdk.domain.invoice.InvoiceComments;
...
import net.siegmar.billomat4j.sdk.domain.invoice.InvoiceGroups;
import net.siegmar.billomat4j.sdk.domain.invoice.InvoiceItem;
import net.siegmar.billomat4j.sdk.domain.invoice.InvoiceItems;
...
import net.siegmar.billomat4j.sdk.domain.invoice.InvoicePayments;
import net.siegmar.billomat4j.sdk.domain.invoice.InvoicePdf;
import net.siegmar.billomat4j.sdk.domain.invoice.InvoiceTag;
import net.siegmar.billomat4j.sdk.domain.invoice.InvoiceTags;
import net.siegmar.billomat4j.sdk.domain.invoice.Invoices;
