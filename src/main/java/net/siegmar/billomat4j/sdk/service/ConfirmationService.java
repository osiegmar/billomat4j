...
public interface ConfirmationService extends
     ...
     * {@link net.siegmar.billomat4j.sdk.domain.confirmation.ConfirmationStatus#COMPLETED}.
     *
     * @param confirmationId
    ...
    /**
     * Sets the confirmation status to
     * {@link net.siegmar.billomat4j.sdk.domain.confirmation.ConfirmationStatus#CANCELED}.
     *
     * @param confirmationId
     *            the id of the confirmation to update
     * @throws net.siegmar.billomat4j.sdk.service.impl.ServiceException
    ...
    /**
     * Sets the confirmation status to {@link net.siegmar.billomat4j.sdk.domain.confirmation.ConfirmationStatus#CLEARED}
     * .
     *
     * @param confirmationId
     *            the id of the confirmation to update
