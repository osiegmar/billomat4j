...
import net.siegmar.billomat4j.sdk.domain.invoice.InvoiceActionKey;
...
public interface InvoiceService extends
    ...
    /**
     * Sets the invoice status to {@link net.siegmar.billomat4j.sdk.domain.invoice.InvoiceStatus#COMPLETED}.
     *
     * @param invoiceId
    ...
    /**
     * Sets the invoice status to {@link net.siegmar.billomat4j.sdk.domain.invoice.InvoiceStatus#CANCELED}.
     *
     * @param invoiceId
     *            the id of the invoice to update
     * @throws net.siegmar.billomat4j.sdk.service.impl.ServiceException
